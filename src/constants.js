...
exports.STX_DECIMALS = exports.JING_CONTRACTS = exports.TokenMapInverse = exports.TokenMap = void 0;
exports.TokenMap = {
    ...
    LiALEX: "SP102V8P0F7JX67ARQ77WEA3D3CFB5XW39REDT0AM.auto-alex-v3::auto-alex-v3",
    Friedger: "SPN4Y5QPGQA8882ZXW90ADC2DHYXMSTN8VAR8C3X.friedger-token-v1::friedger",
    ...
    TRUTH: "SP2ECF9BD90CXW96XYT032MG6BQ2N6TRQ47V0D90R.september-11-stxcity::TRUTH",
    HOAX: "SP116BXQNYGH2SDF64Z68CRPKVTK93KWTVXTA2DYD.moon-landing-stxcity::HOAX",
    FlatEarth: "SP3W69VDG9VTZNG7NTW1QNCC1W45SNY98W1JSZBJH.flat-earth-stxcity::FlatEarth",
    ...
    Moist: "SPBNZD0NMBJVRYJZ3SJ4MTRSZ3FEMGGTV2YM5MFV.moist-sock-bonding-curve::Moist",
    GYAT: "SP739VRRCMXY223XPR28BWEBTJMA0B27DY8GTKCH.gyatt-bonding-curve::GYAT",
    BOOSTER: "SP345FTTDC4VT580K18ER0MP5PR1ZRP5C3Q0KYA1P.booster-bonding-curve::BOOSTER",
    ...
    iouWELSH: "SP2ZNGJ85ENDY6QRHQ5P2D4FXKGZWCKTB2T0Z55KS.synthetic-welsh::iouWELSH",
...
exports.TokenMapInverse = Object.entries(exports.TokenMap).reduce(function (acc, _a) {
    var _b;
    var symbol = _a[0], ft = _a[1];
    return (__assign(__assign({}, acc), (_b = {}, _b[ft] = symbol, _b)));
}, {});
exports.JING_CONTRACTS = {
    BID: {
